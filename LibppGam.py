...
def sigma_pi_Geant4(Tp):
	...
	"""
    return sigma_1pi(Tp) + sigma_2pi(Tp) + sigma_inel(Tp)*multip_pi0_Geant4(Tp)
...
def sigma_pi_Pythia8(Tp):
	...
	XS_pi0 - is the pi0 production cross section in [mb]
	"""
    return sigma_1pi(Tp) + sigma_2pi(Tp) + sigma_inel(Tp)*multip_pi0_Pythia8(Tp)
...
def sigma_pi_SIBYLL(Tp):
	...
	XS_pi0 - is the pi0 production cross section in [mb]
	"""
    return sigma_1pi(Tp) + sigma_2pi(Tp) + sigma_inel(Tp)*multip_pi0_SIBYLL(Tp)
...
def sigma_pi_QGSJET(Tp):
	...
	XS_pi0 - is the pi0 production cross section in [mb]
	"""
    return sigma_1pi(Tp) + sigma_2pi(Tp) + sigma_inel(Tp)*multip_pi0_QGSJET(Tp)
...
def Amax_Geant4(Tp):
    ...
    if Tp <= Tp_th:
        ...
        Amax = 5.9*sigma_pi_Geant4(Tp)/Epi0_max_LAB(Tp)
